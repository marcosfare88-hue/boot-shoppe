...
AUTO_REPLY_MSG = (
    ...
    "https://s.shopee.com.br/1gGFOZSQls\n\n"
...
def exemplo_publicar_post():
    resultado = publicar_post(
        ...
        caption="Confira nosso produto! 🥾 https://s.shopee.com.br/1gGFOZSQls"
    )
...
def exemplo_publicar_carrossel():
    resultado = publicar_carrossel(
        ...
        caption="Veja nosso catalogo! 🥾 https://s.shopee.com.br/1gGFOZSQls"
    )
